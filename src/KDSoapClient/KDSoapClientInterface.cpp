...
QBuffer *KDSoapClientInterfacePrivate::prepareRequestBuffer(const QString &method, const KDSoapMessage &message,
                                                            const KDSoapHeaders &headers, const QString &action)
{
...
{
    QBuffer *buffer = d->prepareRequestBuffer(method, message, headers, soapAction);
...
bool KDSoapClientInterfacePrivate::useWsAddressing() const
{
    return m_useWsAddressing;
}

void KDSoapClientInterfacePrivate::setUseWsAddressing(bool useWsAddressing)
{
...
bool KDSoapClientInterface::useWsAddressing() const
{
    return d->useWsAddressing();
}
